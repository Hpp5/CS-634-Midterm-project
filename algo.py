...
def append_data():
    ...
    print("Hello, Welcome to association rule mining\nPlease choose the dataset for which you would like to get the Association rules output")
    print("Please type \n1 for Amazon\n2 for BestBuy\n3 for KMART\n4 for Nike\n5 for Custom")
    while True:
        datachoice = input()
        if (datachoice == '1'):
            data ='amazon.csv'
            print('You selected (1)Amazon Dataset')
            break
        elif(datachoice == '2'):
            data = 'bestbuy.csv'
            print('You selected (2)BestBuy Dataset')
            break
        elif(datachoice == '3'):
            data = 'kmart.csv'
            print('You selected (3)KMART Dataset')
            break
        elif(datachoice == '4'):
            data = 'nike.csv'
            print('You selected (4)Nike Dataset')
            break
        elif(datachoice == '5'):
            data = 'grocery.csv'
            print('You selected (5)Custom Dataset')
            break
        else:
...
if __name__ == "__main__":
    ...
    for Lisk in List:
        print("-*"*40)
        print("frequent " + str(len(list(List)[0])) + "-itemsets\t\tsupport")
        print("-*"*40)
